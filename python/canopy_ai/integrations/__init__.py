    ...
    return [
        {
            ...
            "execute": _make_pay_executor(canopy),
        },
        {
            ...
            "execute": _make_discover_executor(canopy),
        },
        {
            "name": "canopy_approve",
            "description": (
            ...
            "execute": _make_decide_executor(canopy, "approve"),
        },
        {
            "name": "canopy_deny",
            "description": (
            ...
            "execute": _make_decide_executor(canopy, "deny"),
        },
    ]
